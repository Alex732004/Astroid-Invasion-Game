...
rulesDisplay5 = my_font.render("3. You need to get a total of 250 points to beat the game. Points are accumulated by moving.", True, WHITE)
rulesDisplay6 = my_font.render("4. You only have one life so be careful.", True, WHITE)
